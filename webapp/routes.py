...
def specific_card(card_url):
    ...
    if my_card["sequence"] > 1:
        previous_card_url = (
            ...
            + list(
                filter(
                    lambda previous_card: previous_card["sequence"]
                    == (my_card["sequence"] - 1),
                    my_deck,
                )
            )[0]["url"]
    ...
    if my_card["sequence"] < 78:
        next_card_url = (
            ...
            + list(
                filter(
                    lambda next_card: next_card["sequence"]
                    == (my_card["sequence"] + 1),
                    my_deck,
                )
            )[0]["url"]
